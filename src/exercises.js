export const routines = {
  ...
  Night: [
    ...
    {
      id: "night-adductor-rockback",
      name: "Quadruped adductor rock-back + hip rotation",
      type: "reps",
      target: 6,
      unit: "per side",
      sideSpecific: true,
      tags: ["hips", "adductors", "groin"],
      core: true,
      quickPriority: 1,
      breathing:
        "Inhale forward. Exhale as you rock back and gently rotate the pelvis.",
      instructions:
        "Start on all fours. Extend one leg straight out to the side with the foot planted. Rock the hips backward, then add a small comfortable hip rotation. Do not force the groin.",
      image: "/exercises/adductor-rockback.png",
    },
    {
      id: "night-squat",
      name: "Bodyweight squats",
  ...
  "Pre-Snow": [
    ...
    {
      id: "snow-adductor-rockback",
      name: "Quadruped adductor rock-back + hip rotation",
      type: "reps",
      target: 5,
      unit: "per side",
      sideSpecific: true,
      tags: ["hips", "adductors", "snowboarding"],
      core: true,
      quickPriority: 1,
      breathing:
        "Inhale forward. Exhale as you rock back and rotate gently.",
      instructions:
        "Start on all fours, extend one leg to the side, rock back smoothly and add a small comfortable hip rotation.",
      image: "/exercises/adductor-rockback.png",
    },
    {
      id: "snow-squats",
