...
/*
  Mobility Coach SVG Diagram Library

  These diagrams are rendered directly in the app.
...
function SideBendDiagram() {
  return (
    <Diagram label="Standing overhead side bend">
      ...
      <path
        d="M108 58 Q88 38 79 17"
        {...lineProps}
      />

      <path
        d="M112 57 Q98 33 93 12"
        {...lineProps}
      />
...
function StandingRotationDiagram({
  golf = false,
}) {
  return (
    <Diagram
...
function WallSlideDiagram() {
  return (
    <Diagram label="Wall slide">
      ...
      <path
        d="M92 57 L75 43 L71 18"
        {...lineProps}
      />

      <path
        d="M94 57 L112 42 L119 17"
        {...lineProps}
      />
...
function WindshieldWipersDiagram({
  hold = false,
}) {
  return (
    <Diagram
    ...
    >
      ...
      <path
        d="M121 104 L155 81 L190 101"
        {...lineProps}
      />

      <path
        d="M121 104 L154 128 L190 118"
        {...lineProps}
      />
...
function SupineTwistDiagram() {
  return (
    <Diagram label="Supine spinal twist">
      ...
      <path
        d="M120 98 Q149 107 162 132"
        {...lineProps}
      />

      <path
        d="M120 98 Q148 112 177 128"
        {...lineProps}
      />
...
function ChildPoseDiagram() {
  return (
    <Diagram label="Child pose lat stretch">
      ...
      <path
        d="M101 93 Q84 109 78 131"
        {...lineProps}
      />

      <path
        d="M80 131 Q111 138 140 120"
        {...lineProps}
      />
...
function SeatedRotationDiagram() {
  return (
    <Diagram label="Seated thoracic rotation">
      ...
      <path
        d="M111 95 L137 111 L137 144"
        {...lineProps}
      />

      <path
        d="M111 95 L88 111 L88 144"
        {...lineProps}
      />
...
function HipFlexorDiagram() {
  return (
    <Diagram label="Standing hip flexor stretch">
      ...
      <path
        d="M116 90 L91 112 L72 144"
        {...lineProps}
      />

      <path
        d="M116 90 L142 110 L174 144"
        {...lineProps}
      />
...
function KneeWallDiagram({
  ...
  return (
    ...
    >
      ...
      <path
        d="M108 89 L139 112 L164 138"
        {...lineProps}
      />

      <path
        d="M108 89 L89 113 L77 144"
        {...lineProps}
      />
...
function LateralShiftDiagram() {
  return (
    <Diagram label="Lateral weight shifts">
      ...
      <path
        d="M120 94 L84 112 L61 144"
        {...lineProps}
      />

      <path
        d="M120 94 L157 112 L180 144"
        {...lineProps}
      />
